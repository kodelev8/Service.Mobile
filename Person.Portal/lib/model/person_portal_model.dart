...
//
//     final personPortalModel = personPortalModelFromJson(jsonString);

import 'dart:convert';

PersonPortalModel personPortalModelFromJson(String str) => PersonPortalModel.fromJson(json.decode(str));

String personPortalModelToJson(PersonPortalModel data) => json.encode(data.toJson());
...
class PersonPortalModel {
  ...
  factory PersonPortalModel.fromJson(Map<String, dynamic> json) => PersonPortalModel(
    id: json["id"],
    sofiNr: json["sofiNr"],
    ...
    adresBuitenland: json["adresBinnenland"] != null ?AdresBuitenland.fromJson(json["adresBuitenland"]) : null,
